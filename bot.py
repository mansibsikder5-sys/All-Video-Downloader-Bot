...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 📥 মূল ইউজারের চ্যাটে ওয়েলকাম মেসেজ
    ...
    # 📢 আপনার ব্যাকআপ চ্যানেলে নতুন ইউজারের তথ্য পাঠানো
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        print(f"Error: {str(e)}")
        await status_message.edit_text("❌ দুঃখিত! ভিডিওটি প্রসেস করা সম্ভব হয়নি।")
        try:
...
def main():
    ...
    print("Bot is starting with Channel Backup system...")
